...
const navigation = [
    { name: 'Alamat', href: '#', current: true },
    { name: 'Pemesanan', href: '#', current: false },
                            ...
                            <div className="mt-3 px-2 space-y-1">
                                {userNavigation.map((item) => (
                                    <Disclosure.Button
                                        ...
                                        as="a"
                                        href={item.href}
                                        className="block px-3 py-2 rounded-md text-base font-medium text-teal-400 hover:text-white hover:bg-teal-700"
                                    >
                                        {item.name}
                                    </Disclosure.Button>
                                ))}
